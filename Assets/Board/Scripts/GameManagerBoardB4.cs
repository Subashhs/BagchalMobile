...
public class GameManagerBoard4 : MonoBehaviour
{
    ...
    private BaseAI tigerAI; // AI for controlling the Tiger
    private BaseAI goatAI;  // AI for controlling the Goats
    ...
    private void InitializeBoard()
    {
        ...
        if (PlayerIsTiger)
        {
            ...
            if (tiles.ContainsKey("Tile_0_0") && tigerPrefab != null)
            {
                ...
                playerTiger.AddComponent<NewTigerSelectionB4>();
                playerTiger.GetComponent<TigerMovementB4>().enabled = true;
            ...
            string[] aiGoatPositions = { "Tile_4_0", "Tile_4_1", "Tile_4_2" };
            ...
            foreach (string position in aiGoatPositions)
            {
                if (tiles.ContainsKey(position) && goatPrefab != null)
                {
                    ...
                    goat.GetComponent<GoatMovementB4>().enabled = true;
            ...
            aiGoats = tempAIGoats;
            goatAI = new GoatAI(aiGoats.ToArray(), playerTiger, tiles); // AI controls Goats
        ...
        else
        {
            ...
            if (tiles.ContainsKey("Tile_0_0") && tigerPrefab != null)
            {
                ...
                aiTiger.GetComponent<TigerMovementB4>().enabled = true;
            ...
            string[] playerGoatPositions = { "Tile_4_0", "Tile_4_1", "Tile_4_2" };
            ...
            foreach (string position in playerGoatPositions)
            {
                ...
                {
                    GameObject goat = Instantiate(goatPrefab, tiles[position].transform.position, Quaternion.identity);
                    goat.AddComponent<NewGoatSelectionB4>();
                    goat.GetComponent<GoatMovementB4>().enabled = true;
            ...
            tigerAI = new TigerAI(aiTiger, playerGoats.ToArray(), tiles); // AI controls Tiger
    ...
    public void MovePiece(GameObject targetTile)
    {
        if (currentTurn == Turn.Player && selectedPiece != null && tiles.ContainsValue(targetTile))
        {
            ...
            {
                TigerMovementB4 tigerMovement = playerTiger.GetComponent<TigerMovementB4>();
            ...
            {
                GoatMovementB4 goatMovement = selectedPiece.GetComponent<GoatMovementB4>();
    ...
    {
        TigerMovementB4 tigerMovement = tigerToCheck.GetComponent<TigerMovementB4>();
